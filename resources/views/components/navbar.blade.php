<nav class="bg-synapso-navy text-white shadow p-4 flex justify-between items-center">
    ...
    <div class="flex items-center space-x-6">
        <a href="{{ route('dashboard') }}"><span class="text-2xl font-bold">Synapso</span></a>
        ...
        <div x-data="{ open: false }" class="relative">
            ...
            <div x-show="open" @click.outside="open = false" x-transition
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button type="submit"
                        class="w-full text-left px-4 py-2 text-sm text-slate-700 hover:bg-slate-100 hover:bg-synapso-bg hover:text-synapso-navy">
                        Cerrar sesión
                    </button>
                </form>
